...
一、软件概览
- **0.0** [启动页面](/spot/document?id=_0-启动页面)

二、数据载入
- **1.1** [质谱仪器选择页面](/spot/document?id=_11-质谱仪器选择页面)
- **1.2** [标准样品库页面](/spot/document?id=_12-标准样品库页面)
- **1.3** [载入数据页面](/spot/document?id=_13-载入数据页面)
- **1.4** [样品匹配页面](/spot/document?id=_14-样品匹配页面)
- **1.5** [预览与异常剔除页面](/spot/document?id=_15-预览与异常剔除页面)
- **1.6** [分类预览页面](/spot/document?id=_16-分类预览页面)

三、微量元素分析
- **2.1** [含量标样分组页面](/spot/document?id=_21-含量标样分组页面)
- **2.2** [简单外标法与检测限页面](/spot/document?id=_22-简单外标法与检测限页面)
- **2.3** [简单外标归一化校正页面](/spot/document?id=_23-简单外标归一化校正页面)
- **2.4** [单/多外标内标法校正页面](/spot/document?id=_24-单多外标内标法校正页面)

四、定年分析
- **3.1** [定年标样与指标选择页面](/spot/document?id=_31-定年标样与指标选择页面)
- **3.2** [定年分析和微调](/spot/document?id=_32-定年分析和微调)
- **3.3** [U-Pb谐和度调整](/spot/document?id=_33-U-Pb谐和度调整)
- **3.4** [U-Pb谐和-反谐和曲线页面](/spot/document?id=_34-U-Pb谐和-反谐和曲线页面)
